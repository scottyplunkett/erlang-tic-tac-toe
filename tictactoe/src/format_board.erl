-module(format_board).
-export([get_board_length/1,get_board_row_length/1,make_new_board/0,split_board_into_rows/1,split_board_into_rows/2]).
...
split_board_into_rows([],ListOfRowSublists,_,_) 
	-> ListOfRowSublists;
split_board_into_rows([FirstCell|RestOfCells],ListOfRowSublists,PositionInRow,FilledRowSize) 
	when PositionInRow==FilledRowSize 
